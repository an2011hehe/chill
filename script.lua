...
local menuWidth = isMobile and math.floor(screenWidth * 0.92) or 620
local menuHeight = isMobile and math.floor(screenHeight * 0.78) or 520
...
MainFrame.Name = "Main"
MainFrame.Size = UDim2.fromOffset(menuWidth, menuHeight)
...
TitleBar.Size = UDim2.new(1, 0, 0, isMobile and 44 or 48)
...
TitleLabel.Size = UDim2.new(0, isMobile and 150 or 200, 1, 0)
...
CloseBtn.Size = UDim2.new(0, isMobile and 36 or 32, 0, isMobile and 36 or 32)
CloseBtn.Position = UDim2.new(1, isMobile and -44 or -40, 0.5, isMobile and -18 or -16)
...
CloseCorner.CornerRadius = UDim.new(0, isMobile and 18 or 16)
CloseCorner.Parent = CloseBtn

local MinimizeBtn = Instance.new("TextButton")
MinimizeBtn.Size = UDim2.new(0, isMobile and 36 or 32, 0, isMobile and 36 or 32)
MinimizeBtn.Position = UDim2.new(1, isMobile and -88 or -78, 0.5, isMobile and -18 or -16)
...
MinimizeCorner.CornerRadius = UDim.new(0, isMobile and 18 or 16)
...
MinimizeBtn.MouseButton1Click:Connect(function()
    ...
    if isMinimized then
        ...
        TweenService:Create(MainFrame, TweenInfo.new(0.3, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
            Size = UDim2.fromOffset(menuWidth, isMobile and 44 or 48),
        }):Play()
        for _, child in ipairs(MainFrame:GetChildren()) do
            if child ~= TitleBar and child ~= BgImage and child ~= DarkOverlay and child.Name ~= "BackgroundImage" and child.Name ~= "DarkOverlay" and child ~= MainCorner and child ~= MainStroke then
                child.Visible = false
            end
        end
        MinimizeBtn.Text = "□"
...
UserInputService.InputChanged:Connect(function(input)
    if isDragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        MainFrame.Position = UDim2.new(
            startPos.X.Scale, math.clamp(startPos.X.Offset + delta.X, 0, screenWidth - MainFrame.AbsoluteSize.X),
            startPos.Y.Scale, math.clamp(startPos.Y.Offset + delta.Y, 0, screenHeight - MainFrame.AbsoluteSize.Y)
        )
    end
end)
...
Sidebar.Size = UDim2.new(0, SidebarWidth, 1, -(isMobile and 44 or 48))
Sidebar.Position = UDim2.new(0, 0, 0, isMobile and 44 or 48)
...
SidebarList.Padding = UDim.new(0, isMobile and 2 or 4)
SidebarList.HorizontalAlignment = Enum.HorizontalAlignment.Center
SidebarList.Parent = SidebarScroll

local ContentArea = Instance.new("Frame")
ContentArea.Size = UDim2.new(1, -SidebarWidth, 1, -(isMobile and 44 or 48))
ContentArea.Position = UDim2.new(0, SidebarWidth, 0, isMobile and 44 or 48)
...
for _, tab in ipairs(Tabs) do
    ...
    list.Padding = UDim.new(0, isMobile and 6 or 10)
...
for _, tab in ipairs(Tabs) do
    local btnHeight = isMobile and 38 or 42

    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(1, -12, 0, btnHeight)
    ...
    iconLabel.Size = UDim2.new(0, isMobile and 24 or 30, 1, 0)
    iconLabel.Position = UDim2.new(0, isMobile and 8 or 14, 0, 0)
    iconLabel.BackgroundTransparency = 1
    iconLabel.Text = tab.Icon
    iconLabel.TextColor3 = Color3.fromRGB(150, 150, 160)
    iconLabel.Font = Enum.Font.Gotham
    iconLabel.TextSize = isMobile and 14 or 17
    iconLabel.ZIndex = 2
    iconLabel.Parent = btn

    local nameLabel = Instance.new("TextLabel")
    nameLabel.Size = UDim2.new(1, -(isMobile and 40 or 52), 1, 0)
    nameLabel.Position = UDim2.new(0, isMobile and 36 or 48, 0, 0)
...
local function CreateSection(parent, title)
    ...
    sec.Size = UDim2.new(1, 0, 0, isMobile and 36 or 40)
    ...
    secCorner.CornerRadius = UDim.new(0, isMobile and 10 or 14)
    ...
    accent.Size = UDim2.new(0, 3, 0, isMobile and 16 or 20)
    accent.Position = UDim2.new(0, isMobile and 10 or 14, 0.5, isMobile and -8 or -10)
    ...
    txt.Position = UDim2.new(0, isMobile and 18 or 24, 0, 0)
    txt.BackgroundTransparency = 1
    txt.Text = title
    txt.TextColor3 = Color3.fromRGB(240, 240, 245)
    txt.TextXAlignment = Enum.TextXAlignment.Left
    txt.Font = Enum.Font.GothamBold
    txt.TextSize = isMobile and 10 or 11
    txt.ZIndex = 2
    txt.Parent = sec
end
...
local function AddToggle(parent, text, default, callback)
    ...
    frame.Size = UDim2.new(1, 0, 0, isMobile and 28 or 32)
    ...
    bg.Size = UDim2.new(0, isMobile and 40 or 44, 0, isMobile and 22 or 24)
    bg.Position = UDim2.new(1, isMobile and -42 or -46, 0.5, isMobile and -11 or -12)
    ...
    dot.Size = UDim2.new(0, isMobile and 16 or 18, 0, isMobile and 16 or 18)
    dot.Position = UDim2.new(0, 3, 0.5, isMobile and -8 or -9)
    ...
    dotCorner.CornerRadius = UDim.new(0, isMobile and 8 or 9)
    ...
    local function update()
        if state then
            TweenService:Create(dot, TweenInfo.new(0.15, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
                Position = UDim2.new(1, isMobile and -19 or -21, 0.5, isMobile and -8 or -9),
            ...
            TweenService:Create(dot, TweenInfo.new(0.15, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
                Position = UDim2.new(0, 3, 0.5, isMobile and -8 or -9),
...
local function AddSlider(parent, text, min, max, default, float, callback)
    local frame = Instance.new("Frame")
    frame.Size = UDim2.new(1, 0, 0, isMobile and 44 or 48)
    frame.BackgroundTransparency = 1
    frame.ZIndex = 2
    frame.Parent = parent

    local top = Instance.new("Frame")
    top.Size = UDim2.new(1, 0, 0, isMobile and 16 or 18)
    ...
    valLbl.TextSize = isMobile and 10 or 11
    valLbl.ZIndex = 2
    valLbl.Parent = top

    local sf = Instance.new("Frame")
    sf.Size = UDim2.new(1, 0, 0, isMobile and 20 or 22)
    sf.Position = UDim2.new(0, 0, 0, isMobile and 18 or 20)
    sf.BackgroundTransparency = 1
    sf.ZIndex = 2
    sf.Parent = frame

    local sliderBg = Instance.new("TextButton")
    sliderBg.Size = UDim2.new(1, 0, 0, isMobile and 5 or 6)
    sliderBg.Position = UDim2.new(0, 0, 0.5, isMobile and -2.5 or -3)
...
local function AddButton(parent, text, callback, color)
    ...
    btn.MouseButton1Down:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.05, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
            Size = UDim2.new(1, 0, 0, isMobile and 33 or 35),
        }):Play()
    end)
